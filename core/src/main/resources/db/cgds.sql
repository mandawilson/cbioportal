...
CREATE TABLE `mutation` (
  ...
  `DIP_LOG_R float DEFAULT NULL,
  `SEG_MEAN float DEFAULT NULL,
  `CELLULAR_FRACTION` float DEFAULT NULL,
  `TOTAL_COPY_NUMBER` int(6) DEFAULT NULL,
  `MINOR_COPY_NUMBER` int(6) DEFAULT NULL,
  `PURITY` float DEFAULT NULL,
  `PLOIDY` float DEFAULT NULL,
  `CCF_M_COPIES` float DEFAULT NULL,
  `CCF_M_COPIES_LOWER` float DEFAULT NULL,
  `CCF_M_COPIES_UPPER` float DEFAULT NULL,
  `CCF_M_COPIES_PROB95` float DEFAULT NULL,
  `CCF_M_COPIES_PROB90` float DEFAULT NULL,
  `CCF_1_COPY` float DEFAULT NULL,
  `CCF_1_COPY_LOWER` float DEFAULT NULL,
  `CCF_1_COPY_UPPER` float DEFAULT NULL,
  `CCF_1_COPY_PROB95` float DEFAULT NULL,
  `CCF_1_COPY_PROB90` float DEFAULT NULL,
