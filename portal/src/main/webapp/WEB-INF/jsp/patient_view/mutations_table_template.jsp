...
--%>
                ...
                <thead>
                    <tr valign="bottom">
                        ...
                        <th class="mut-header" alt="FACETS Cancer Cell Fraction M Copies Prob 95"><b>CCF M Copies Prob 95</b></th>
                        <th class="mut-header" alt="FACETS Cancer Cell Fraction M Copies Prob 90"><b>CCF M Copies Prob 90</b></th>
                        <th class="mut-header" alt="FACETS Cancer Cell Fraction 1 Copy"><b>CCF 1 Copy</b></th>
                        <th class="mut-header" alt="FACETS Cancer Cell Fraction 1 Copy Lower"><b>CCF 1 Copy Lower</b></th>
                        <th class="mut-header" alt="FACETS Cancer Cell Fraction 1 Copy Upper"><b>CCF 1 Copy Upper</b></th>
                        <th class="mut-header" alt="FACETS Cancer Cell Fraction 1 Copy Prob 95"><b>CCF 1 Copy Prob 95</b></th>
                        <th class="mut-header" alt="FACETS Cancer Cell Fraction 1 Copy Prob 90"><b>CCF 1 Copy Prob 90</b></th>
                        <th class="mut-header" alt="FACETS Cell Fraction (Per Segment)"><b>CF</b></th>
                        <th class="mut-header" alt="Load BAM for this mutation via IGV"><b>BAM</b></th>
                        <th class="mut-header" alt="FACETS Total Copy Number"><b>Total Copy #</b></th>
                        <th class="mut-header" alt="FACETS Minor Copy Number"><b>Minor Copy #</b></th>
                        <th class="mut-header" alt="FACETS Best Guess for Mutant Copies"><b>Mutant Copies</b></th>
                        <th class="mut-header" alt="FACETS Best Guess for Mutant Copies / Total Copies"><b>Mutant Copies</b></th>
                        ...
                        <th class="mut-header" alt="FACETS Dip Log R (Per Sample)"><b>Dip Log R</b></th>
                        <th class="mut-header" alt="FACETS Seg Mean (Per Segment)"><b>Seg Mean</b></th>
                        <th class="mut-header" alt="FACETS Purity (Per Sample)"><b>Purity</b></th>
                        <th class="mut-header" alt="FACETS Ploidy (Per Sample)"><b>Ploidy</b></th>
                    </tr>
                </thead>
