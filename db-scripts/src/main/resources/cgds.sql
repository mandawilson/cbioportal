...
CREATE TABLE `mutation` (
  ...
  `TOTAL_COPY_NUMBER` INTEGER(6),
  `MINOR_COPY_NUMBER` INTEGER(6),
  `CELLULAR_FRACTION_EM` FLOAT,
  `PURITY` FLOAT,
  `PLOIDY` FLOAT,
  `CCF_M_COPIES` FLOAT,
  `CCF_M_COPIES_LOWER` FLOAT,
  `CCF_M_COPIES_UPPER` FLOAT,
  `CCF_M_COPIES_PROB95` FLOAT,
  `CCF_M_COPIES_PROB90` FLOAT,
  `CCF_M_COPIES_EM` FLOAT,
  `CCF_M_COPIES_LOWER_EM` FLOAT,
  `CCF_M_COPIES_UPPER_EM` FLOAT,
  `CCF_M_COPIES_PROB95_EM` FLOAT,
  `CCF_M_COPIES_PROB90_EM` FLOAT,
  `TOTAL_COPY_NUMBER_EM` INTEGER(6),
  `MINOR_COPY_NUMBER_EM` INTEGER(6),
...
INSERT INTO info VALUES ('2.7.4', NULL);
