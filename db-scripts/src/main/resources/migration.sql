...
ALTER TABLE mutation 
    ADD COLUMN DIP_LOG_R FLOAT,
    ADD COLUMN CELLULAR_FRACTION FLOAT,
    ADD COLUMN TOTAL_COPY_NUMBER INTEGER(6),
    ADD COLUMN MINOR_COPY_NUMBER INTEGER(6),
    ADD COLUMN CELLULAR_FRACTION_EM FLOAT,
    ADD COLUMN PURITY FLOAT,
    ADD COLUMN PLOIDY FLOAT,
    ADD COLUMN CCF_M_COPIES FLOAT,
    ADD COLUMN CCF_M_COPIES_LOWER FLOAT,
    ADD COLUMN CCF_M_COPIES_UPPER FLOAT,
    ADD COLUMN CCF_M_COPIES_PROB95 FLOAT,
    ADD COLUMN CCF_M_COPIES_PROB90 FLOAT,
    ADD COLUMN CCF_M_COPIES_EM FLOAT,
    ADD COLUMN CCF_M_COPIES_LOWER_EM FLOAT,
    ADD COLUMN CCF_M_COPIES_UPPER_EM FLOAT,
    ADD COLUMN CCF_M_COPIES_PROB95_EM FLOAT,
    ADD COLUMN CCF_M_COPIES_PROB90_EM FLOAT,
    ADD COLUMN TOTAL_COPY_NUMBER_EM INTEGER(6),
    ADD COLUMN MINOR_COPY_NUMBER_EM INTEGER(6);

ALTER TABLE copy_number_seg 
    ADD COLUMN SEG INTEGER(6),
    ADD COLUMN N_HET INTEGER(6),
    ADD COLUMN CNLR_MEDIAN DOUBLE,
    ADD COLUMN MAF_R DOUBLE,
    ADD COLUMN SEG_CLUST INTEGER(6),
    ADD COLUMN CNLR_MEDIAN_CLUST DOUBLE,
    ADD COLUMN MAF_R_CLUST DOUBLE,
    ADD COLUMN CELLULAR_FRACTION DOUBLE,
    ADD COLUMN TOTAL_COPY_NUMBER INTEGER(6),
    ADD COLUMN MINOR_COPY_NUMBER INTEGER(6),
    ADD COLUMN CELLULAR_FRACTION_EM DOUBLE,
    ADD COLUMN TOTAL_COPY_NUMBER_EM INTEGER(6),
    ADD COLUMN MINOR_COPY_NUMBER_EM INTEGER(6);
